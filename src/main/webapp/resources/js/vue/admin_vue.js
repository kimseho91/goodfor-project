	...
	admin_body : x=>{
		...
		<tr id="testDown" style="width: 100%; height: 100%;">
			<td id="testLeft" style="width: 12%; height: 850px; vertical-align: top; background-color: rgb(202, 207, 210);">
				...
				<div id="selectbtn3" style="width: 80%; height: 90px; color: rgb(26, 82, 118); font-size: large; font-weight: 800; text-align: right;"><a id="btn_attention" href="">관심종목</a></div>
			</td>
			<td id="testMiddle" style="width: 78%; height: 850px; vertical-align: top; background-color: rgb(244, 246, 246);">
				...
				<div id="boxfour" style="float: left; width: 43%; height: 500px; margin: 30px; border: 5px solid white; padding: 10px; background-color: rgb(251, 238, 230);">그래프 1 : 최근 1년간 월별 결건수 및 체결금액</div>
				<div id="boxfive" style="float: left; width: 43%; height: 500px; margin: 30px; border: 5px solid white; padding: 10px; background-color: rgb(251, 238, 230);">그래프 2 : 최근 1년간 월별 유고객 명수 및 예치금액</div>
			</td>
